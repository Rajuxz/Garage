...
urlpatterns = [
    ...
    #download daily and weekly reports
    path('download_daily_report',views.download_daily_report,name="daily-report"),
    path('download_weekly_report',views.download_weekly_report,name='weekly-report'),
